...
namespace Orangedkeys.ParticlesFX
{
    public class WelcomeParticlesFX : EditorWindow
    {
        ...
        [MenuItem("Tools/OrangedKeys/ParticlesFX_Pack/About ", false, 0)]
        public static void ShowWindow()
        {
            EditorWindow editorWindow = GetWindow(typeof(WelcomeParticlesFX), false, " About ", true);
        ...
        private void OnGUI()
        {
            ...
            */
            ...
            // Add The Banner
            Texture2D welcomeImage = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Orangedkeys/ParticlesFX_Pack/Resources/ParticlesFX_PACK.png", typeof(Texture2D));
            ...
            EditorGUILayout.LabelField("Have fun with ''PARTICLES FX PACK'' !! \n", LargeTextStyle);
            EditorGUILayout.Space();
