...
public class ParticlesMasterShader_GUI : ShaderGUI
{
    ...
    void DoMain()
    {
        ...
        else
        {
            ...
            MaterialProperty _Shape = FindProperty("_Shape");
            editor.ShaderProperty(_Shape, MakeLabel(_Shape));

            /*
            MaterialProperty _Sides = FindProperty("_Sides");
            editor.ShaderProperty(_Sides, MakeLabel(_Sides)); 

            MaterialProperty _EdgyGlowFactor = FindProperty("_EdgyGlowFactor");
            editor.ShaderProperty(_EdgyGlowFactor, MakeLabel(_EdgyGlowFactor));
            

            MaterialProperty _UseShapeAlpha = FindProperty("_UseShapeAlpha");
            editor.ShaderProperty(_UseShapeAlpha, MakeLabel(_UseShapeAlpha));
